                            ...
                            <?php while ($row = mysqli_fetch_array($query)) { ?>
                                <tr>
                                    ...
                                    <td class="col-md-2">
                                        ...
                                        <a href="exeDeleteTaiKhoan.php?id_user=<?php echo $row['id_user'] ?>"> <button class="btn btn-danger btn_del" data-confirm="Bạn có chắc chắn muốn xóa?" onclick="btn_delete()">Xóa</button></a>
